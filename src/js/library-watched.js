...
// import { API_KEY, BASE_URL, IMAGE_URL } from './movie-service';
...
function renderWatched(e) {
  ...
  if (loadWatched === undefined || loadWatched.length === 0) {
    ...
    <p class="empty-library-text">Sorry, we can't find your watched films :(</p>
    `;
...
export function appendFilm(films) {
  ...
  library.innerHTML = '';
  library.insertAdjacentHTML('beforeend', createFilmCardMarkup(normalObjs));
}
