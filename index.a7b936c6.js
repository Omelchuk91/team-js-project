 ...
 * limitations under the License.
 */
(0,s("ix4Jr").registerVersion)("firebase","9.13.0","app")})),s.register("axgPN",(function(e,r){t(e.exports,"formBackdropRef",(function(){return h})),t(e.exports,"onLogOut",(function(){return g})),t(e.exports,"onShowAuthModal",(function(){return y})),t(e.exports,"onClickBackdrop",(function(){return _}));var i=s("eWCmQ");s("amyG6");var o=s("30XCk"),a=s("6kcu2"),l=s("6cjWj"),c=s("XwkCV"),u=s("eWnKO");const h=document.querySelector(".form-backdrop"),d=document.querySelectorAll(".btn"),f={formSingInBtn:document.querySelector(".form-signin"),formSingUpBtn:document.querySelector(".form-signup"),frameRef:document.querySelector(".frame"),signUpItemRef:document.querySelector(".signup-inactive"),signInItemRef:document.querySelector(".signin-active"),btnSingUpClick:document.querySelector(".btn-signup"),btnSingInClick:document.querySelector(".btn-signin"),btnAnimateDiv:document.querySelector(".btn-animate"),btnAnimateSignupDiv:document.querySelector(".btn-animate-signup"),signinEmail:document.querySelector(".signin-email"),signinPassword:document.querySelector(".signin-password"),signupName:document.querySelector(".signup-name"),signupEmail:document.querySelector(".signup-email"),signupPassword:document.querySelector(".signup-password"),welcome:document.querySelector(".welcome"),frame:document.querySelector(".frame"),success:document.querySelector(".success")};function p(){f.formSingInBtn.classList.toggle("form-signin-left"),f.formSingUpBtn.classList.toggle("form-signup-left"),f.frameRef.classList.toggle("frame-long"),f.signUpItemRef.classList.toggle("signup-active"),f.signUpItemRef.classList.toggle("signup-inactive"),f.signInItemRef.classList.toggle("signin-inactive"),f.signInItemRef.classList.toggle("signin-active")}function m(e,t="#232b55"){f.welcome.textContent=e,f.welcome.style.color=t,f.btnAnimateDiv.classList.add("btn-animate-grow"),f.welcome.classList.add("welcome-left"),setTimeout((()=>{f.welcome.classList.remove("welcome-left"),f.btnAnimateDiv.classList.remove("btn-animate-grow"),f.welcome.style.color="#232b55"}),3e3)}function g(){(0,l.readNameFromBase)().then((e=>{e?n(i).Notify.info(`${e} logged out`,{position:"center-top",fontFamily:"inherit",borderRadius:"25px",clickToClose:!0}):n(i).Notify.info("You logged out",{position:"center-top",fontFamily:"inherit",borderRadius:"25px",clickToClose:!0})})).catch(),a.auth.signOut()}function y(){h.classList.remove("is-hidden"),window.addEventListener("keydown",b)}function v(){h.classList.add("is-hidden"),window.removeEventListener("keydown",b),f.btnAnimateDiv.classList.remove("btn-animate-grow"),f.welcome.classList.remove("welcome-left")}function _(e){e.target.classList.contains("formbackdrop-close-modal")&&v()}function b(e){"Escape"===e.code&&v()}d.forEach((e=>e.addEventListener("click",p))),f.btnSingInClick&&f.btnSingInClick.addEventListener("click",(function(){const e=f.signinEmail.value,t=f.signinPassword.value;(0,o.a6)(a.auth,e,t).then((e=>{const t=e.user;localStorage.setItem("auth","1"),(0,c.addNav)("index"),(0,c.removeAuthBtns)(),(0,c.addLogOutButton)(),(0,l.readNameFromBase)().then((e=>{m(e?`Welcome, ${e}`:`Welcome, ${t.email}`)})).catch(m(`Welcome, ${t.email}`)),setTimeout((()=>{v()}),3e3),f.signinEmail.value="",f.signinPassword.value=""})).catch((e=>{const t=e.code,n=e.message;console.log(t+n),m("Login Error. Wrong user or password.")}))})),f.btnSingUpClick&&f.btnSingUpClick.addEventListener("click",(function(){const e=f.signupName.value,t=f.signupEmail.value,n=f.signupPassword.value;if(console.log((0,u.validateData)(e,t,n).error),(0,u.validateData)(e,t,n).error)return void m(`${(0,u.validateData)(e,t,n).error}`,"#fff");(0,o.a5)(a.auth,t,n).then((n=>{const r=n.user;localStorage.setItem("auth","1"),(0,c.addNav)("index"),(0,c.removeAuthBtns)(),(0,c.addLogOutButton)(),m(`Welcome, ${e}`,"#fff"),setTimeout((()=>{v()}),3e3),(0,l.addUser)(r.uid,e,t),f.signupName.value="",f.signupEmail.value="",f.signupPassword.value=""})).catch((e=>{e.code;const t=e.message;console.log(t),m("Sign Up Error. Something wrong.","#fff"),setTimeout((()=>{f.btnAnimateDiv.classList.toggle("btn-animate-grow"),f.welcome.classList.toggle("welcome-left"),f.welcome.style.color="#232b55"}),4e3)}))}))})),s.register("6cjWj",(function(e,n){t(e.exports,"addUser",(function(){return l})),t(e.exports,"readNameFromBase",(function(){return c})),s("fQ3Fn");var r=s("8NPS8"),i=s("6kcu2"),o=s("4UGc2");const a=(0,r.getDatabase)(o.default);function l(e,t,n){(0,r.set)((0,r.ref)(a,"users/"+e),{username:t,email:n})}function c(){const e=i.auth.currentUser.uid,t=(0,r.ref)(a);return(0,r.get)((0,r.child)(t,"users/"+e+"/username")).then((e=>{if(e.exists())return e.val()}))}})),s.register("fQ3Fn",(function(e,n){t(e.exports,"getDatabase",(function(){return s("8NPS8").getDatabase})),t(e.exports,"set",(function(){return s("8NPS8").set})),t(e.exports,"ref",(function(){return s("8NPS8").ref})),t(e.exports,"push",(function(){return s("8NPS8").push})),t(e.exports,"get",(function(){return s("8NPS8").get})),t(e.exports,"child",(function(){return s("8NPS8").child})),s("8NPS8")})),s.register("8NPS8",(function(e,n){t(e.exports,"child",(function(){return xi})),t(e.exports,"ref",(function(){return wi})),t(e.exports,"push",(function(){return ki})),t(e.exports,"set",(function(){return Ci})),t(e.exports,"get",(function(){return Ii})),t(e.exports,"getDatabase",(function(){return Ai}));var r=s("ix4Jr"),i=s("4a6xH"),o=s("ffjl9"),a=s("7vF8m"),l=s("4TNnu");const c="@firebase/database",u="0.13.10";
/**
 * @license
 * Copyright 2019 Google LLC
 *
